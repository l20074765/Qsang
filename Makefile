#############################################################################
# Makefile for building: Qsang
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ??? 25 09:47:35 2014
# Project:  Qsang.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe -spec c:\Qt\4.8.6\mkspecs\win32-g++ CONFIG+=release -o Makefile Qsang.pro
#############################################################################
...
Makefile: Qsang.pro  c:/Qt/4.8.6/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.6\mkspecs\win32-g++ CONFIG+=release -o Makefile Qsang.pro
